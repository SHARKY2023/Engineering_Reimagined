...
public class AdvancedSolarPanelTile extends SolarPanelTile {

    public AdvancedSolarPanelTile() {
        super(SolarPanelTier.Advanced, Registration.SOLAR_TILE_ADVANCED.get());
    }
}