...
public class CrusherContainer extends AbstractContainerMenu {
    ...
    public CrusherContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        ...
        if (tileEntity != null) {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                addSlot(new SlotItemHandler(h, 1, 64, 24));
                addSlot(new SlotItemHandler(h, 2, 128, 24));
            });
        }
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()), playerEntity, Registration.CRUSHER.get());
    }
