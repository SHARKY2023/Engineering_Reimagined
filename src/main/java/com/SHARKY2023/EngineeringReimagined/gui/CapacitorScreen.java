...
public class CapacitorScreen extends AbstractContainerScreen<CapacitorContainer> {
        ...
        public CapacitorScreen(CapacitorContainer container, Inventory inv, Component name) {
